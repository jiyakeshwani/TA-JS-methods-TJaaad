...
function countAllPeople(obj) {
  return obj.houses.map((house) => house.people).flat().length;
}
console.log(got);
...
function surnameWithS() {
  return obj.houses
    ...
    .flat()
    .map((person) => person.name)
    .filter((person) => person.includes("S"));
}
console.log(nameWithS(got));
...
function surnameWithA() {
  return obj.houses
    ...
    .flat()
    .map((person) => person.name)
    .filter((person) => person.includes("a"));
}
console.log(nameWithA(got));
